...
ui, _ = loadUiType('librarychg.ui')
    

# Main Application Class
class LibraryApp(QMainWindow,ui):
    def __init__(self):
        super(LibraryApp, self).__init__()
        loadUi("librarychg.ui", self)  # Load the UI file

        # Accessing the button correctly after loading the UI
        self.pushButton_7.clicked.connect(self.add_book())
        self.pushButton_17.clicked.connect(self.search_book)
        self.pushButton_6.clicked.connect(self.issue_book)
